...
- `AppConfig` — весь пользовательский конфиг: позиция и прозрачность орба, горячая
  клавиша, тема, режим переполнения колеса, список целей и пресеты правил. Именно этот
  объект сохраняется в `config.json`.
