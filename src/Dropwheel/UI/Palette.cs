...
/// the wheel-focused Theme record so dialogs, the editor, and menus can match the theme too.
/// Success/Warning/Danger/Info are the shared feedback roles used by both dialogs (validation
/// text, danger buttons) and the wheel (drop badges, broken-target marks) so one operation
/// never means two different colors in two places.</summary>
...
public static class Palettes
{
    ...
    public static readonly Dictionary<string, Palette> All = new()
    {
        ["Fluent"] = new(
            ...
            AccentText: C(0xFF, 0xFF, 0xFF, 0xFF), Selection: C(0x18, 0x2C, 0x7B, 0xE5),
            Success: C(0xFF, 0x1F, 0x9D, 0x57), Warning: C(0xFF, 0xE0, 0x86, 0x00),
            Danger: C(0xFF, 0xD1, 0x34, 0x38), Info: C(0xFF, 0x2C, 0x7B, 0xE5), Dark: false),
        ...
        ["Dark"] = new(
            ...
            AccentText: C(0xFF, 0x0A, 0x0E, 0x14), Selection: C(0x2A, 0x6F, 0xA8, 0xFF),
            Success: C(0xFF, 0x46, 0xC9, 0x80), Warning: C(0xFF, 0xF0, 0xA9, 0x3C),
            Danger: C(0xFF, 0xF0, 0x55, 0x5C), Info: C(0xFF, 0x6F, 0xA8, 0xFF), Dark: true),
        ...
        ["Light"] = new(
            ...
            AccentText: C(0xFF, 0xFF, 0xFF, 0xFF), Selection: C(0x18, 0x0B, 0x62, 0xC6),
            Success: C(0xFF, 0x1C, 0x8A, 0x4E), Warning: C(0xFF, 0xC6, 0x76, 0x08),
            Danger: C(0xFF, 0xC4, 0x2B, 0x2B), Info: C(0xFF, 0x0B, 0x62, 0xC6), Dark: false),
        ...
        ["Neon"] = new(
            ...
            AccentText: C(0xFF, 0x04, 0x12, 0x1A), Selection: C(0x30, 0x29, 0xD8, 0xFF),
            Success: C(0xFF, 0x35, 0xF0, 0xA6), Warning: C(0xFF, 0xFF, 0xC2, 0x4D),
            Danger: C(0xFF, 0xFF, 0x6B, 0x72), Info: C(0xFF, 0x35, 0xD6, 0xFF), Dark: true),
    };
    ...
    public static Brush Success => Brush(Current.Success);
    public static Brush Warning => Brush(Current.Warning);
    public static Brush Danger => Brush(Current.Danger);
    public static Brush Info => Brush(Current.Info);
}
