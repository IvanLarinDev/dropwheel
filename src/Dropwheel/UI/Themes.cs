...
public record Theme(
    ...
    Color Backdrop); // legible dark surface for wheel overlays (toast, shortcut indicator) floating over the desktop
...
public static class Themes
{
    ...
    /// <summary>Exposes palette roles as window resource keys so XAML in dialogs can bind muted text,
    /// borders, and danger through DynamicResource instead of hard-coded brushes.</summary>
    private static void ApplyRoleKeys(System.Windows.Window w, Palette p)
    {
