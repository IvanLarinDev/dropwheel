...
| Передвинуть кружок    | Alt + ЛКМ, тянуть                            |
...
- Виртуальные файлы (вложения Outlook, картинки из браузера) — в планах.
- Один уровень целей, без групп; мультимонитор — частично (один кружок).
- Раскрытие «при приближении» drag требует наведения на сам кружок
  (глобальный хук мыши — в планах).
